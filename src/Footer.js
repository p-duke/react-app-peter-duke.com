                  ...
                  <div className="row">
                    <div className="col-offset-2 vcenter">
                        <button type="submit" className="btn btn-warning btn-lg">
                          <a href="https://drive.google.com/open?id=0B43Ydmpo69cbSlc5eVBkaHptVG8" target="_blank"><span className="glyphicon glyphicon-save-file" aria-hidden="true"></span> Download Resume</a>
                        </button>
