              ...
              <div className="row">
                  <div className="col-md-4">
                      ...
                      <button type="button" className="btn btn-info btn-lg">
                        <a target="_blank" href="https://drive.google.com/open?id=0B43Ydmpo69cbRTBUSVdETWRCMFk"><span className="glyphicon glyphicon-save-file" aria-hidden="true"></span> Download Resume</a>
                      </button>
                  </div>
